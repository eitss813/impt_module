    ...
    public function saveValues()
    {
        ...
        if(!empty($values['playlist_id']))
            ...
            if ($playlist->search) {
                ...
                $action   = $activity->addActivity(Engine_Api::_()->user()->getViewer(), $playlist, 'music_playlist_new', null, array('count' => count($file_ids), 'privacy' => isset($values['networks'])? $network_privacy : null));
                if (null !== $action)
