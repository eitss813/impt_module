...
$viewer = Engine_Api::_()->user()->getViewer();
 ...
 if (Engine_Api::_()->core()->hasSubject('user') && Engine_Api::_()->core()->getSubject('user') && $subject = Engine_Api::_()->core()->getSubject('user') &&  !empty($subject) && !empty($viewer) && $viewer->getIdentity() == $subject->getIdentity() ) {
