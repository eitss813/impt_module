            ...
            <li>
                <div class="sitevideo_thumb_wrapper sitevideo_thumb_viewer">
                    <div class="sitevideo_list_thumb">
                        ...
                        <?php
                        echo $this->htmlLink($item->getHref(), "<span class='video_overlay'></span> <span class='play_icon'></span>" . $fsContent . $fsDuration . $this->itemBackgroundPhoto($item, $this->gridViewThumbnailType, '', array('tag' => 'i')), array('class'=> 'sitevideo_thumb'));
                        ?>
