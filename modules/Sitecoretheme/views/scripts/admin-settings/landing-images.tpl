 ...
 * @version    $Id: landing-images.tpl 2019-07-09 15:11:20Z SocialEngineAddOns $
...
<h3><?php echo $this->translate('Landing Page Slider Images'); ?></h3>
<p class="form-description">
    <?php echo $this->translate('Here, you can add, delete and manage your images. In order to change the sequence of images, drag and drop images vertically and set them in any order you want them to appear on landing page. Multiple images can be added to display them in circular manner i.e one after another.') ?>
</p>

<br />
<p>
    <a href='<?php echo $this->url(array("module" => 'sitecoretheme', "controller" => "settings", "action" => 'add-images'), "admin_default", true) ?>' class="smoothbox buttonlink seaocore_icon_add"><?php echo $this->translate("Add New Image"); ?></a>
</p>
            ...
            <ul id='menu_list'>
                <?php foreach ($this->list as $item): ?>
                    <li id="content_<?php echo $item->getIdentity(); ?>" class="admin_table_bold item_label">
                        ...
                        <div class="center" style="width:15%;text-align:center;">
                            <a href='<?php echo $this->url(array("module" => 'sitecoretheme', "controller" => "settings", "action" => 'enabled', 'id' => $item->getIdentity()), "admin_default", true) ?>' >
                        ...
                        <div class="center" style="width:15%;text-align:center;">
                            <a href='<?php echo $this->url(array("module" => 'sitecoretheme', "controller" => "settings", "action" => 'delete', 'id' => $item->getIdentity()), "admin_default", true) ?>' class="smoothbox"><?php echo "Delete"; ?></a>
                        </div>
