...
<script type="text/javascript">
	...
	$(document).ready(function() {
		sm4.core.Module.autoCompleter.attach("user_ids", '<?php echo $this->url(array('module' => 'sitepagemember', 'controller' => 'index', 'action' => 'getmembers', 'page_id' => $this->page_id), 'default', true) ?>', {'singletextbox': false, 'limit':10, 'minLength': 1, 'showPhoto' : false, 'search' : 'text'}, 'toValues'); 
	});
