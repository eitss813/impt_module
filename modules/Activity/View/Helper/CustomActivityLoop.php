 ...
 * @license    http://www.socialengine.com/license/
 */
class Activity_View_Helper_CustomActivityLoop extends Activity_View_Helper_Activity
{
  public function customActivityLoop($actions = null, array $data = array())
    {
