...
class Activity_Model_DbTable_Actions extends Engine_Db_Table
{
    ...
    public function getActivityActions(User_Model_User $user, array $params = array())
    {
        ...
        foreach( $masterActionTypes as $type ) {
         ...
         // @todo : show all actvitiy type in activty page
...
//        }
    ...
    public function getActionsAbout(Core_Model_Item_Abstract $about, User_Model_User $user, array $params = array())
    {
        ...
        // Naaziya: 27th july 2020:
        // As some actionType for projects are using object concept instead of subject concept
        // but these types were in $subjectActionTypes array but not present in $objectActionTypes array due to "displayable" field condition ($type->displayable & 2)
        // so manually added here
        $objectActionTypes[] = 'sitecrowdfunding_project_back';
