 ...
 * @license    http://www.socialengine.com/linotifications_rightsidecense/
...
<script type="text/javascript">
  en4.core.runonce.add(function() {
    ...
    var activityViewMore = window.activityViewMore = function(next_id, subject_guid) {
      ...
      let actLink = '<?php echo $this->actualLink; ?>';
      ...
      var request = new Request.HTML({
        ...
        onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript) {
          ...
          // to load the signup buttons after view-more clicked
...
<div class="activity-post-container nolinks">
 ...
 <div style="width: 100%;">
   <form method="post" id="post-form" action="<?php echo $this->url(array('module' => 'activity', 'controller' => 'index', 'action' => 'post'), 'default', true) ?>" class="activity" enctype="application/x-www-form-urlencoded" id="activity-form">
       <div class="feed_item_photo" style="margin-top: 9px;margin-bottom: 5px;display: flex;">
         <p id="" style="margin-top: 0px;margin-left: 8px;font-size: 16px;font-weight: 500;color: #626262;display: flex;align-items: center  ">
           <?php
     ...
     <input type="hidden" id="userId" name="user_ids" value="<?php print_r($this->user_ids); ?>" />
     ...
     <div id="compose-menu" class="compose-menu">
       <div class="compose-right-content">
                ...
                <div class="privacy_pulldown_contents_wrapper">
                  <div class="privacy_pulldown_contents">
                    <ul>
                      ...
                      <?php if($value == 'Everyone' || $value=='Friends Only' || $value=='Only Me'): ?>
         ...
         <button onclick="sendMail()"  class="submit-share" id="compose-submit user_auth_link nolinks" type="submit"><?php echo $this->translate("Share") ?></button>
       </div>
     </div>
   </form>
...
<div class="activity-post-container  nolinks">
  ...
  <form method="post" action="<?php echo $this->url(array('module' => 'activity', 'controller' => 'index', 'action' => 'post'), 'default', true) ?>" class="activity" enctype="application/x-www-form-urlencoded" id="activity-form">
    ...
    <div id="compose-menu"  class="compose-menu">
      ...
      <div class="compose-right-content test1 user_auth_link">

        <div>
          <a id="compose-photo-activator" class="compose-activator user_auth_link buttonlink" href="javascript:void(0);">Add Photo</a>
          <a id="compose-link-activator" class="compose-activator user_auth_link  buttonlink" href="javascript:void(0);">Add Link</a>
          <a id="compose-video-activator" class="compose-activator user_auth_link buttonlink" href="javascript:void(0);">Add Video</a>
        </div>
        ...
        <div style="float: right">
          ...
          <div class='privacy_list user_auth_link' id='privacy_list'>
              <span class="privacy_pulldown" id="privacy_pulldown" onmousedown="togglePrivacyPulldown(this);">
                <p class="privacy_list_tip">
                  <span id="privacy_lable_tip">
                    <?php echo $this->translate("Share with %s", $this->defaultPrivacyLabel) ?>
          ...
          <input type="hidden" id="auth_view" name="auth_view" value="<?php echo $this->defaultPrivacy; ?>" />
          <button id="compose-submit  nolinks" class="user_auth_link" type="submit"><?php echo $this->translate("Share") ?></button>
        </div>
        ...
        <div class="compose-right-content" >
          ...
          <div style="float: right">
            ...
            <input type="hidden" id="auth_view" name="auth_view" value="<?php echo $this->defaultPrivacy; ?>" />
            <button onclick="sendMail()" class="submit-share" id="compose-submit  nolinks" class="user_auth_link" type="submit"><?php echo $this->translate("Share") ?></button>
          </div>
...
<style>
  ...
  .compose-right-content.seao_popup_user_auth_link {
    display: flex;
...
<script>
  ...
  window.addEvent('domready', function () {
    ...
    //   console.log('testtttttt',document.getElementById('userId'));
    //   console.log('subject',document.getElementById('subject'));
    // })
    $j('.submit-share').click(function () {
      console.log('subject 111111');
      var urlShare = '<?php echo $this->url(array('module' => 'activity', 'controller' => 'index', 'action' => 'mail' ), 'default', true);?>';
      if(document.getElementById('userId') ) {
        let user_id = document.getElementById('userId').value;
        let subject = (document.getElementById('subject')) ?  document.getElementById('subject').value : null;
        let action_id = document.getElementById('action_id') ? document.getElementById('action_id').value : null;
        ...
        en4.core.request.send(new Request.HTML({
          ...
          onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
            console.log('subject 11',responseElements);
            console.log('subject 11',responseTree);
          }
        }), true);
      }
  ...
  function sendMail() {
    ...
    if(document.getElementById('userId') ) {
      let user_id = document.getElementById('userId').value;
      let subject = (document.getElementById('subject')) ?  document.getElementById('subject').value : null;
      let action_id = document.getElementById('action_id').value;
      let flag = document.getElementById('flag').value;
      console.log('action_idaction_id',action_id);
      en4.core.request.send(new Request.HTML({
        method: 'post',
        'url': urlShare,
        'data': {
...
<style>
  a#compose-photo-activator,a#compose-link-activator,a#compose-music-activator,a#compose-video-activator {
