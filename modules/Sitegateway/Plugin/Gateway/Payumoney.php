...
//customer email
    ...
    public function createUserOrderTransaction($parent_order_id, array $params = array(), $user = NULL) {
        ...
        if ($params['source_type'] == 'siteeventticket_order') {
            ...
            $product_info = "You have received Rs." . @round($grand_total, 2) . " payment for Order Id #" . $parent_order_id . " in store.";
            $params['product_info'] = $product_info;
        ...
        if ($params['source_type'] == 'sitecredit_order') {
            ...
            $product_info = "You have received Rs." . $order->grand_total . " payment for Order Id #" . $parent_order_id . " for credits.";
            $params['product_info'] = $product_info;
