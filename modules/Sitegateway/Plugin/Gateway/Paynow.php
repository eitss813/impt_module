...
/**
 * All the methods defined in this file will be required to update as per your new payment gateway requirement. However for your better understanding, we have given some sample code under some methods of Paynow gateway. You have to change these method's code according to your gateway requirement.
 */
class Sitegateway_Plugin_Gateway_Paynow extends Sitegateway_Plugin_Gateway_Abstract {
    ...
    public function getAdminGatewayForm() {
        return new Sitegateway_Form_Admin_Gateway_Paynow();
    }
