...
Composer.Plugin.Video = new Class({
  ...
  activate : function() {
    ...
    this.elements.formInputContainer = new Element('div', {
    ...
    this.elements.formInput = new Element('input', {
      ...
      'class' : 'compose-form-input',
      'type' : 'text',
    }).inject(this.elements.formInputContainer);

    this.elements.formInputDes = new Element('p', {
    ...
    this.elements.formInputContainer.inject(this.elements.body);
