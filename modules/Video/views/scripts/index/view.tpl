...
<h2>
  ...
  <?php else: ?>
    ...
    <?php echo $this->translate('&#187;'); ?>
  <?php endif; ?>
  <?php if($category =  $this->video->getCategoryItem()): ?>
...
<div class="video_view video_view_container">
  ...
  <div id="video_embed" class="video_embed">
    ...
    <?php }else{ ?>
    <div class="flowplayer" data-embed="false" data-share="false" style="width: 480px;height: 386px;" data-swf="<?php echo $this->layout()->staticBaseUrl; ?>externals/flowplayer/flowplayer.swf">
        <video>
          <source type="video/flv" src="<?php echo $this->video_location ?>">
        </video>
    </div>
    <?php } ?>
