 ...
 * @author     John
 */
class Yndynamicform_Form_Admin_Field extends Engine_Form
{
  protected $_option;
  ...
  public function init()
  {
    ...
    //  $this->setDescription('Edit Form Field');
    ...
    $this->addElement('Textarea', 'description', array(
      ...
      // Add description
      $this->addElement('Checkbox', 'enable_prepopulate', array(
          'label' => 'Enable Pre-populate',
          'rows' => 7,
      ));
