...
var Autocompleter = new Class({
    ...
    doPushSpan: function (name, toID, newItem, hideLoc, list) {
        ...
        if (newItem) {
            ...
            myElement.innerHTML = name + " <a href='javascript:void(0);' onclick='this.parentNode.destroy();removeFromToValue(\"" + toID + "\", \"" + hideLoc + "\");'><span class='ynicon yn-del cal'></span></a>";
        }
        else {
            myElement.id = "tospan_" + name + "_" + toID;
            myElement.innerHTML = name + " <a href='javascript:void(0);' onclick='this.parentNode.destroy();removeFromToValue(\"" + toID + "\", \"" + hideLoc + "\");'><span class='ynicon yn-del cal'></span></a>";
        ...
        myElement.inject($('toValues-element'), 'top');
        this.fireEvent('push');
    },
