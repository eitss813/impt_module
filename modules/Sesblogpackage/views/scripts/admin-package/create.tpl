 ...
 * @version    $Id: create.tpl 2020-03-26 00:00:00 socialnetworking.solutions $
...
<div class="sesbasic_search_result">
  <?php echo $this->htmlLink($this->url(array('module' => 'sesblogpackage', 'controller' => 'package','action'=>'index')), $this->translate("Back to Manage Packages"), array('class' => 'buttonlink sesbasic_icon_back')); ?>
</div><br />
