 ...
 * @version    $Id: IpnController.php 2020-03-26 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Sesblogpackage_IpnController extends Core_Controller_Action_Standard {
  ...
  public function __call($method, array $arguments) {
    ...
    // Log ipn
    $ipnLogFile = APPLICATION_PATH . '/temporary/log/sesblogpackage-ipn.log';
    ...
    try {
      ...
      //Get gateways
      $gatewayTable = Engine_Api::_()->getDbtable('gateways', 'sesblogpackage');
