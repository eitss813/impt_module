 ...
 * @version    $Id: Stripe.php 2020-03-26 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
include_once APPLICATION_PATH . "/application/modules/Sesadvpmnt/Api/Stripe/init.php";
class Sesblogpackage_Plugin_Gateway_Stripe extends Engine_Payment_Plugin_Abstract
{
      ...
      array $params = array())
  {
    ...
    if($package->isOneTime()) {
        ...
        $params['secretKey'] = $this->_gatewayInfo->config['sesadvpmnt_stripe_secret'];
