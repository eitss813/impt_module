                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $this->htmlLink(
																array('route' => 'event_extended', 'module' => 'event', 'controller' => 'admin-settings', 'action' => 'edit-category', 'id' =>$category->category_id),
																$this->translate('edit'),
																array('class' => 'smoothbox',
                        )) ?>
                        |
                        <?php echo $this->htmlLink(
																array('route' => 'event_extended', 'module' => 'event', 'controller' => 'admin-settings', 'action' => 'delete-category', 'id' =>$category->category_id),
