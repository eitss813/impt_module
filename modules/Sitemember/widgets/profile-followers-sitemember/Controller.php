 ...
 */
class Sitemember_Widget_ProfileFollowersSitememberController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        if ($this->_getParam('loaded_by_ajax', false)) {
            ...
            if ($this->_getParam('is_ajax_load', false)) {
                ...
                $this->view->followers = $followers = Zend_Paginator::factory($select);
                $this->_childCount = $followers->getTotalItemCount();
                // print_r($followers->getTotalItemCount());die;
                return;
            }
        }
        ...
        $followers->setItemCountPerPage($this->_getParam('itemCount', 20));
        ...
        if ($this->_getParam('titleCount', false) && $followers->getTotalItemCount() > 0) {
            $this->_childCount = $followers->getTotalItemCount();
        }
    }
