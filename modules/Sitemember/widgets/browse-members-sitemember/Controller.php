 ...
 */
class Sitemember_Widget_BrowseMembersSitememberController extends Seaocore_Content_Widget_Abstract {

    public function indexAction() {
        $this->view->defaultLoadingImage = $this->_getParam('defaultLoadingImage', 0);
        //echo "<pre>"; print_r($this->_getAllParams()); die("data");
        ...
        $this->view->locationMarker = Engine_Api::_()->getApi('settings', 'core')->getSetting('sitemember.location.marker', 0);
        ...
        $checkReqIsAjax = $this->_getParam('is_ajax', 0);
        if ( empty( $checkReqIsAjax ) ) {
