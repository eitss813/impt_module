...
<?php if ($this->map_view && $this->paginator->count() > 0): ?>
  ...
  <?php 
  $language = '';
  if(isset($_COOKIE['en4_language']) && !empty($_COOKIE['en4_language'])) {
  ...
  $this->headScript()->appendFile("https://google-maps-utility-library-v3.googlecode.com/svn/trunk/markerclusterer/src/markerclusterer.js");
  ?>
<?php endif; ?>
...
if ($this->is_ajax_load):
  ...
  <?php if ($this->paginator->count() > 0): ?>
    ...
    <div id="dynamic_app_info_sitemember_<?php echo $this->identity; ?>">
                ...
                <?php if (!empty($sitemember->sponsored)): ?>
                  ...
                  <div class='sitemember_browse_list_photo b_medium'>
                    ...
                    <?php if (!empty($this->statistics) && in_array('sponsoredLabel', $this->statistics) && !empty($sitemember->sponsored)): ?>
                      <div class="seaocore_list_sponsored_label" style="background: <?php echo $this->settings->getSetting('sitemember.sponsoredcolor', '#FC0505'); ?>">
                ...
                <li class="b_medium">
                  ...
                  <div class='sitemember_browse_list_info'>
                    ...
                    <?php if (!empty($this->links) || $pokeFlag || $suggestionFlag):?>
                      <div class="clr sitemember_action_link_options">
                        <?php
                        //FOR MESSAGE LINK

                        if ((Engine_Api::_()->seaocore()->canSendUserMessage($items)) && (!empty($viewer_id)) && !empty($this->links) && in_array('messege', $this->links)) :
                          ?>
                          <span><a href="<?php echo $this->baseUrl() ?>/messages/compose/to/<?php echo $sitemember->user_id ?>" target="_parent" class="buttonlink" style=" background-image: url(<?php echo $this->baseUrl() ?>/application/modules/Messages/externals/images/send.png);"><?php echo $this->translate('Message'); ?></a></span>
                        <?php endif; ?>
                        ...
                        return false;" class="buttonlink" style="background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Poke/externals/images/poke_icon.png);"><?php echo $this->translate("Poke") ?></a></span>
                       <?php } //END POKE WORK.?>
                        ...
                        <?php if ($suggestionFlag) { ?>
                          ...
                          <span><a href="javascript:void(0);" onclick="showSmoothBox('<?php
                            ...
                            ?>');
                        return false;" class="buttonlink" style="background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Suggestion/externals/images/sugg_blub.png);"><?php echo $this->translate("Suggest to Friends") ?></a></span>
      ...
      <?php if ($this->grid_view): ?>
        <div id="image_view" class="sitemember_container" <?php if ($this->defaultView != 1): ?> style="display: none;" <?php endif; ?>>
            ...
            foreach ($this->paginator as $sitemember):
              ...
              <div class="sitemember_grid_view" style="width: <?php echo $this->columnWidth; ?>px;height:<?php echo $this->columnHeight; ?>px;">
                <div class="sitemember_grid_thumb">
                  <a href="<?php echo $sitemember->getHref() ?>" class="sitemember_thumb">
                    ...
                    ?>
                    <?php echo $this->itemBackgroundPhoto($sitemember, 'thumb.profile', $sitemember->getTitle(), array('tag' => 'span')); ?>
                  </a>
              ...
              <!--                            <img title="Offline" src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Seaocore/externals/images/offline.png' alt="" class="fleft" />-->
                  ...
                  <div class="clr">
                    ...
                    if ((Engine_Api::_()->seaocore()->canSendUserMessage($items)) && (!empty($viewer_id)) && !empty($this->links) && in_array('messege', $this->links)) : 
                      ?>
                      <a href="<?php echo $this->baseUrl() ?>/messages/compose/to/<?php echo $sitemember->user_id ?>" target="_parent" class="buttonlink" style=" background-image: url(<?php echo $this->baseUrl() ?>/application/modules/Messages/externals/images/send.png);"><?php echo $this->translate('Message'); ?></a>
                    <?php endif; ?>
                    <?php
                    if (!empty($this->links) && in_array('addfriend', $this->links)):
                      //Add friend link.
                    ...
                    if (!empty($pokeEnabled) && (!empty($getpokeFriend)) && ($resource_id !=
                      ...
                      echo $this->escape($this->url(array('route' => 'poke_general', 'module' => 'poke', 'controller' => 'pokeusers',
                                  'action' => 'pokeuser', 'pokeuser_id' => $resource_id, 'format' => 'smoothbox'), 'default', true));
                      ?>');
                    return false;" class="buttonlink" style="background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Poke/externals/images/poke_icon.png);"><?php echo $this->translate("Poke") ?></a>
                       <?php } //END POKE WORK.                      ?>


                    <!--FOR SUGGESTION LINK SHOW IF SUGGESTION PLUGIN INSTALL AT HIS SITE.-->    
                    <?php
                    $suggestionEnabled = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('suggestion');
                    $getMemberFriend = Engine_Api::_()->seaocore()->isMember($resource_id);
                    ...
                    if (!empty($suggestionEnabled) && !empty($getMemberFriend) &&
                      ...
                      echo $this->escape($this->url(array('module' => 'suggestion', 'controller' => 'index', 'action' =>
                                  'switch-popup', 'modName' => 'user', 'modContentId' => $resource_id, 'modError' => 1, 'format' => 'smoothbox'), 'default', true));
                      ?>');
                    return false;" class="buttonlink" style="background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Suggestion/externals/images/sugg_blub.png);"><?php echo $this->translate("Suggest to Friends") ?></a>
                       <?php } //END SUGGESTION WORK.   ?>
                  </div>
                </div>
              </div>
      ...
      if ($this->pinboard_view):
        ?>
        <div id="pinboard_view" class="sitemember_container" <?php if ($this->defaultView != 3): ?> style="display: none;" <?php endif; ?>  style="display: none; position: relative; height: 909px;"z>
                    ...
                    <?php if (!empty($this->show_buttons)): ?>
                      ...
                      <div class="seaocore_board_list_action_links">
                        ...
                        <?php if (in_array('like', $this->show_buttons)): ?>
                          <a href="javascript:void(0)" class="seaocore_board_icon like_icon <?php echo $sitemember->getGuid() ?>like_link" id="<?php echo $sitemember->getType() ?>_<?php echo $sitemember->getIdentity() ?>like_link" <?php if ($sitemember->likes()->isLike($this->viewer())): ?>style="display: none;" <?php endif; ?>onclick="en4.seaocorepinboard.likes.like('<?php echo $sitemember->getType() ?>', '<?php echo $sitemember->getIdentity() ?>');" ><?php echo $this->translate('Like'); ?></a>

                          <a  href="javascript:void(0)" class="seaocore_board_icon unlike_icon <?php echo $sitemember->getGuid() ?>unlike_link" id="<?php echo $sitemember->getType() ?>_<?php echo $sitemember->getIdentity() ?>unlike_link" <?php if (!$sitemember->likes()->isLike($this->viewer())): ?>style="display:none;" <?php endif; ?> onclick="en4.seaocorepinboard.likes.unlike('<?php echo $sitemember->getType() ?>', '<?php echo $sitemember->getIdentity() ?>');"><?php echo $this->translate('Unlike'); ?></a>
                        <?php endif; ?>


                        <?php if (in_array('facebook', $this->show_buttons)): ?>
                          <?php echo $this->htmlLink('http://www.facebook.com/share.php?u=' . $urlencode . '&t=' . $sitemember->getTitle(), $this->translate('Facebook'), array('id' => 'pb_ch_wd', 'class' => 'pb_ch_wd seaocore_board_icon fb_icon', 'onclick' => 'childWindowOpen(this);')) ?>
                        <?php endif; ?>

                        <?php if (in_array('twitter', $this->show_buttons)): ?>
                          <?php echo $this->htmlLink('http://twitter.com/share?url=' . $urlencode . '&text=' . $sitemember->getTitle(), $this->translate('Twitter'), array('class' => 'pb_ch_wd seaocore_board_icon tt_icon', 'onclick' => 'childWindowOpen(this);')) ?>
                        <?php endif; ?>

                        <?php if (in_array('pinit', $this->show_buttons)): ?>
                          <a href="http://pinterest.com/pin/create/button/?url=<?php echo $urlencode; ?>&media=<?php echo urlencode((!preg_match("~^(?:f|ht)tps?://~i", $sitemember->getPhotoUrl('thumb.profile')) ? (((!empty($_ENV["HTTPS"]) && 'on' == strtolower($_ENV["HTTPS"])) ? "https://" : "http://") . $_SERVER['HTTP_HOST'] ) : '') . $sitemember->getPhotoUrl('thumb.profile')); ?>&description=<?php echo $sitemember->getTitle(); ?>"  class="pb_ch_wd seaocore_board_icon pin_icon" onclick="childWindowOpen(this);" ><?php echo $this->translate('Pin It') ?></a>
                        <?php endif; ?>
                      </div>
                      <!--                      </div>-->
                    <?php endif; ?>
