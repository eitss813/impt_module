 ...
 */
class Sitemember_Widget_TopRatedTableViewController extends Engine_Content_Widget_Abstract {

    public function indexAction() {
        $this->view->viewer = $viewer = Engine_Api::_()->user()->getViewer();
        $values['viewMembers'] = 'rating_avg';
        ...
        $searchWidgetName = Engine_Api::_()->sitemember()->getContentWidgetName('sitemember_review_top-rated');
        ...
        $paginator->setItemCountPerPage($this->_getParam('itemCount', 5));
