 ...
 */
class Sitemember_Widget_TopReviewersTableViewController extends Engine_Content_Widget_Abstract {

    public function indexAction() {
        $this->view->viewer = $viewer = Engine_Api::_()->user()->getViewer();
        $values['viewMembers'] = 'top_reviewer_count';
        ...
        $searchWidgetName = Engine_Api::_()->sitemember()->getContentWidgetName('sitemember_top-reviewers');
