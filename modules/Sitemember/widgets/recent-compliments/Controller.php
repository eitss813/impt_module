 ...
 */
class Sitemember_Widget_RecentComplimentsController extends Seaocore_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $params = array_merge($params, array("complimentcategory_id" => $this->_getParam('compliment_category',0)));
