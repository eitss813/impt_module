        ...
        <div id="list_view" class="<?php if(!empty($this->circularImage)):?> sitemember_circular_container <?php endif;?>">
           ...
           <ul class="sitemember_browse_list sitemember_list_view">
              ...
              foreach ($this->paginator as $compliment):
                      ...
                      $resourceItem = Engine_Api::_()->getItem($compliment->resource_type,$compliment->resource_id);
                ?>
                <?php ?>
                    ...
                    <div class="sitemember_browse_list_info_header">
                      <div class="seaocore_browse_list_info_title">
                        ...
                        ?>
                           ...
                           <span class="sitemember_complimented_on"><?php echo $this->translate('complimented on ').$this->htmlLink($resourceItem->getHref(), $resourceItem->getTitle(),array()); ?></span>
                    </div>
