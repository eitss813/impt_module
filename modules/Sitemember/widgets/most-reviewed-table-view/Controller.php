 ...
 */
class Sitemember_Widget_MostReviewedTableViewController extends Engine_Content_Widget_Abstract {

    public function indexAction() {
        $this->view->viewer = $viewer = Engine_Api::_()->user()->getViewer();
        $values['viewMembers'] = 'review_count';
        ...
        $searchWidgetName = Engine_Api::_()->sitemember()->getContentWidgetName('sitemember_most_reviewer-members');
