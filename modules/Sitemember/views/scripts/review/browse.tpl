 ...
 * @version    $Id: browse.tpl 2014-07-20 9:40:21Z SocialEngineAddOns $
...
<?php if ($count > 0): ?>
  ...
  ?>
  <div class="sm_browse_lists_view_options mbot15 b_medium">
    <div> 
        ...
        <div class="sm_reviews_listing_info">
          <div class="sm_reviews_listing_title">
            <div class="sm_ur_show_rating_star">
              ...
              <span class="fright">
                <span class="fleft">
                  <?php echo $this->showRatingStarMember($rating_value, $review->type, 'big-star'); ?>
                </span>
                      ...
                      <div class="o_hidden">
                        <?php if (!empty($reviewcat['ratingparam_name'])): ?>
                          ...
                          <div class="parameter_value">
                            <?php echo $this->showRatingStarMember($reviewcat['rating'], $review->type, 'small-box', $reviewcat['ratingparam_name']); ?>
                          </div>
                        <?php else: ?>
                          <div class="parameter_title">
          ...
          <div class="sm_reviews_listing_stat seaocore_txt_light">
            <?php if ($review->recommend && ($review->type == 'user') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sitemember.recommend', 0)): ?>
              <span class="sm_reviews_listing_recommended">
          ...
          <div class="o_hidden">
            ...
            <?php $owner = Engine_Api::_()->getItem('user', $review->owner_id) ?>
            <div class="sm_reviews_listing_photo">
              <?php echo $this->htmlLink($user->getHref(array('profile_link' => 1)), $this->itemPhoto($user, 'thumb.icon', $user->getTitle()), array('class' => "thumb_icon")) ?>
            </div>
            <div class="sm_reviews_listing_info">
              <div class="sm_reviews_listing_stat seaocore_txt_light">
                <?php echo $this->translate('For'); ?>  
                <?php echo $this->htmlLink($user->getHref(), $user->getTitle()) ?><br />
              </div>
            </div> 
          </div> 
          ...
          <div class="sm_reviews_listing_option b_medium">
            <ul>
              <li> 
                <div> 
