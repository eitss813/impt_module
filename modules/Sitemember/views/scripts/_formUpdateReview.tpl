 ...
 * @version    $Id: _formUpdateReview.tpl 2014-07-20 9:40:21Z SocialEngineAddOns $
...
<?php if ($this->can_update): ?>
  ...
  <?php echo $this->translate("Overall Rating"); ?>
    ...
    <div class="form-element">
      ...
      <input type="hidden" name='update_member_rate_0' id='update_member_rate_0' value='<?php echo $rating_value_2; ?>' />
    </div>
  </div>
    ...
    <?php if (!empty($this->total_reviewcats)): ?>
      ...
      <?php echo $this->translate($reviewcat->ratingparam_name); ?>
          ...
          <div class="form-element">
            ...
            <input type="hidden" name='update_member_rate_<?php echo $reviewcat->ratingparam_id; ?>' id='update_member_rate_<?php echo $reviewcat->ratingparam_id; ?>' value='<?php echo $rating_value_1; ?>' />
          </div>
        </div>
    <?php endforeach; ?>
    <?php endif; ?>
...
<script type="text/javascript">
          ...
          function doEditMyRating(element_id, ratingparam_id, classstar) {
            ...
            $('update_member_rate_' + ratingparam_id).value = $(element_id + '_' + ratingparam_id).getParent().id;
          }
