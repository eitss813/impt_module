...
// 			}
      $item = Engine_Api::_()->getItem('user', $resouceId);
       ...
       (Engine_Api::_()->seaocore()->canSendUserMessage($item))) {
          ...
          <?php else : ?>
          <a class="buttonlink" href="<?php echo $this->base_url; ?>/messages/compose/to/<?php echo echo $resouceId ?>" style="background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Messages/externals/images/send.png);">
