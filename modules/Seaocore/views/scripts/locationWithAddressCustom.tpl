...
locationParams = JSON.stringify(locationParams)
document.getElementById('locationParams').value = locationParams;
document.getElementById('formatted_address').value = locationParams.formatted_address;
document.getElementById('latitude').value = locationParams.latitude;
document.getElementById('longitude').value = locationParams.longitude;
document.getElementById('address').value = locationParams.address;
document.getElementById('city').value = locationParams.city;
document.getElementById('zipcode').value = locationParams.zipcode;
document.getElementById('state').value = locationParams.state;
document.getElementById('country').value = locationParams.country;
