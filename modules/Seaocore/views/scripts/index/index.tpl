...
<div class="global_form_1">
  <div>
    <div> The SocialEngineAddOns Core Plugin is not installed on your site. Please download the latest version of this FREE plugin from your Client Area on <a href="http://www.socialengineaddons.com" target="_blank">SocialEngineAddOns</a> and install / upgrade on your website before installing / upgrading this plugin.
    </div>
