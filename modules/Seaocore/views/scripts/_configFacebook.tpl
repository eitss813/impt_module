...
<b>10. Disable Development Mode</b><br/>
After you have created the App, it will be in the development mode, which is its default option. Once you have your app ready for publishing and public usage, you can change its development mode into public, thus allowing it to communicate. 
In the bar (which is just below the header), you will find a button to change the mode.<br/><br/>
<b>11. Save the details in the Admin Panel of SocialEngine Website</b><br/>
...
<br/><br/>
<b>12. Check the functioning of the Facebook App</b><br/>
...
[You can refer this <a href="https://youtu.be/fypfTJ_vGnE" target="blank">video</a> for more details.]
<br/><br/>
                </p></li>
