...
return array(
    'package' => array(
        ...
        'repository' => 'null',
        'title' => 'SocialEngineAddOns Basic Plugin',
        'description' => 'SocialEngineAddOns Basic Plugin',
        ...
        'directories' => array(
            ...
            'externals/seao-fancy-uploader/'
        ),
        'files' => array(
            'application/languages/en/seaocore.csv',
            'application/libraries/Scaffold/modules/DomElementsSeao/DomElementsSeao.php',
            'application/libraries/Engine/Form/Element/SeaoFancyUpload.php',
            'application/libraries/Engine/Form/Decorator/FormSeaoFancyUpload.php',
        ),
    ),
    // Items ---------------------------------------------------------------------
    'items' => array(
