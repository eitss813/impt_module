...
('core_admin_plugins_Seaocore', 'seaocore', 'SEAO - SocialEngineAddOns Basic Plugin', '', '{"route":"admin_default","module":"seaocore","controller":"settings","action":"index"}', 'core_admin_main_plugins', '', 0),
