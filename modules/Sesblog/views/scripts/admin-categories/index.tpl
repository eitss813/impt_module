        ...
        <form id="multimodify_form" method="post" onsubmit="return multiModify();">
          <table class='admin_table' style="width: 100%;">
            ...
            <tbody>
              ...
              <?php continue; ?>
              <?php endif; ?>
              <tr id="categoryid-<?php echo $category->category_id; ?>" data-blog-id="<?php echo $category->category_id; ?>">
              ...
              <tr id="categoryid-<?php echo $sub_category->category_id; ?>" data-blog-id="<?php echo $sub_category->category_id; ?>">
              ...
              <tr id="categoryid-<?php echo $subsub_category->category_id; ?>" data-blog-id="<?php echo $subsub_category->category_id; ?>">
...
jqueryObjectOfSes('#parent').click(function() {
 if(jqueryObjectOfSes('#parent').val() > 0)
   jqueryObjectOfSes('#show_level').hide();
 else
   jqueryObjectOfSes('#show_level').show();
});
