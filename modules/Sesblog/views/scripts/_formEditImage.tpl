 ...
 * @version    $Id: _formEditImage.tpl 2016-07-23 00:00:00 socialnetworking.solutions $
...
<?php if( $this->subject()->photo_id !== null ): ?>
  ...
  <br />
  <div style="display:none;" id="preview-thumbnail" class="preview-thumbnail">
    <?php echo $this->itemPhoto($this->subject(), 'thumb.icon', "", array('id' => 'previewimage')) ?>
  </div>
  <div style="display:none;" id="thumbnail-controller" class="thumbnail-controller">
    <?php if ($this->subject()->getPhotoUrl() && $this->subject()->photo_id)
