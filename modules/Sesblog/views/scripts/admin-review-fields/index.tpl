...
<div class='sesbasic-form sesbasic-categories-form'>
  <div>
    ...
    <div class='clear'>
			<h3><?php echo $this->translate('Review Parameters: Form Questions'); ?></h3>
			<p>
			  <?php echo $this->translate('You might want your users to provide some more information about their blogs. Here, you can create some custom fields of your choice and requirement.<br /><br />To reorder the custom fields, click on their names and drag them up or down. If you want to show different sets of fields to different types of categories, you can create multiple "Profile Types". While adding / editing a category, from the "Map Profile Type" field, you can map and associate Profile Types with Categories.'); ?>
			</p>
			<br />
