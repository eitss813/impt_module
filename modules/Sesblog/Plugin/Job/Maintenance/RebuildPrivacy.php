 ...
 * @version    $Id: RebuildPrivacy.php 2016-07-23 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Sesblog_Plugin_Job_Maintenance_RebuildPrivacy extends Core_Plugin_Job_Abstract
{
  protected function _execute()
  {
    // Start custom prepare
    $table = Engine_Api::_()->getItemTable('sesblog');
