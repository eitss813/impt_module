...
<?php if($this->view_type == 'list'): ?>
  <ul id="widget_sesblog_<?php echo $randonnumber; ?>" class="sesbasic_sidebar_block sesbasic_sidebar_block sesblog_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php else: ?>
  <ul id="widget_sesblog_<?php echo $randonnumber; ?>" class="sesblog_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php endif; ?>
