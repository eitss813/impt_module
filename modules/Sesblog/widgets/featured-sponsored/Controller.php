 ...
 */
class Sesblog_Widget_FeaturedSponsoredController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->params = array('height' => $this->view->height, 'width' => $this->view->width,'description_truncation' => $this->view->description_truncation, 'title_truncation' => $this->view->title_truncation, 'viewType' => $this->view->view_type, 'imageType' => $this->view->image_type, 'show_criterias' => $show_criterias, 'limit_data' => $limit, 'show_star' => $this->view->show_star, 'criteria' => $value['criteria'], 'info' => $value['info'], 'order' => $value['order'], 'socialshare_enable_plusicon' => $socialshare_enable_plusicon, 'socialshare_icon_limit' => $socialshare_icon_limit);
    $page = isset($_POST['page']) ? $_POST['page'] : 1;
    $value['draft'] = "0";
    
    $this->view->results = $paginator = Engine_Api::_()->getDbTable('blogs', 'sesblog')->getSesblogsPaginator($value);
