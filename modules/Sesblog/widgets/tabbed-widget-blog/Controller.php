 ...
 */
class Sesblog_Widget_tabbedWidgetBlogController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'tabbed-widget-blog';			
    $params = array_merge($params, $value);

    // Get Blogs
    $paginator = Engine_Api::_()->getDbtable('blogs', 'sesblog')->getSesblogsPaginator($params);
