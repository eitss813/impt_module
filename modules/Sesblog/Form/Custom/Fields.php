 ...
 */
class Sesblog_Form_Custom_Fields extends Engine_Form {
  /* Custom */
    ...
    if (!empty($this->_topLevelId))
      $selected[$this->_topLevelId] = $this->_topLevelValue;
		if(isset($_POST['category_id']) && $_POST['category_id'] != 0){
			$category_map_id_data	=  Engine_Api::_()->getDbtable('categories', 'sesblog')->getMapId($_POST['category_id']);
		...
		if(isset($_POST['subcat_id']) && $_POST['subcat_id'] != 0){
			$subcategory_map_id_data	=  Engine_Api::_()->getDbtable('categories', 'sesblog')->getSubCatMapId($_POST['subcat_id']);
		...
		if(isset($_POST['subsubcat_id'])  && $_POST['subsubcat_id'] != 0){
			$subsubcategory_map_id_data	=  Engine_Api::_()->getDbtable('categories', 'sesblog')->getSubSubCatMapId($_POST['subsubcat_id']);
