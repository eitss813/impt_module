 ...
 * @version    $Id: Dashboardfields.php 2016-07-23 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Sesblog_Form_Custom_Dashboardfields extends Engine_Form {
  /* Custom */
  ...
  public function generate() {
    ...
    $orderIndex = 0;
		$package = Engine_Api::_()->getItem('sesblogpackage_package',$this->getItem()->package_id);
    ...
    foreach ($struct as $fskey => $map) {
      ...
      $key = $map->getKey();
			if(!in_array($key,$fieldsEnable) && $key != '0_0_1' && $enableCheck == 2)
				continue;
