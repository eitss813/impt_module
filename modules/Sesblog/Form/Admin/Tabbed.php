 ...
 * @version    $Id: Tabbed.php 2016-07-23 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Sesblog_Form_Admin_Tabbed extends Engine_Form {
  ...
  public function init() {
   ...
   $categories = array('' => '') + $categories;
    ...
    //Count 
    $this->addElement('Text', "limit_data_list1", array(
      'label' => 'Count for List Views 1 (number of blogs to show).',
      'value' => 10,
      'validators' => array(
        array('Int', true),
        array('GreaterThan', true, array(0)),
		...
		$this->addElement('Text', "limit_data_list2", array(
      ...
      'validators' => array(
		...
		$this->addElement('Text', "limit_data_list3", array(
      ...
      'validators' => array(
		...
		$this->addElement('Text', "limit_data_list4", array(
    ...
    $this->addElement('Text', "limit_data_grid1", array(
      ...
      'validators' => array(
		...
		$this->addElement('Text', "limit_data_grid3", array(
    ...
    $this->addElement('Text', "limit_data_grid4", array(
