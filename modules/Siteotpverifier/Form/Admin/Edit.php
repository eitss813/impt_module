 ...
 * @license    http://www.socialengine.com/license/
 */
class Siteotpverifier_Form_Admin_Edit extends Engine_Form
{
  ...
  public function init()
  {
    ...
    $this->addElement('Text', 'phoneno', array(
                ...
                'validators' => array(
                    ...
                    array('Db_NoRecordExists', true, array(Engine_Db_Table::getTablePrefix() . 'siteotpverifier_users', 'phoneno',array(
                    'field' => 'user_id',
                    'value' => (int) $this->_userIdentity
                    )))
                ),
