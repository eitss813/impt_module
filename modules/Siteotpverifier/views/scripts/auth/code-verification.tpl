 ...
 * @version    code-verification.tpl 2015-09-10 00:00:00Z SocialEngineAddOns $
...
//<![CDATA[
    ...
    function resendotpCode(){
        ...
        en4.core.request.send(new Request.JSON({
              url: "<?php echo $this->url(array('module' => 'siteotpverifier', 'controller' => 'auth', 'action' => 'resend-otp'), 'default', true); ?>",
              method: 'post',
              data: {
                format: 'json',
