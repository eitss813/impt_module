 ...
 * Time: 1:50 PM
 */
class Yndynamicform_ProjectFormController extends Core_Controller_Action_Standard
{
    ...
    public function detailAction()
    {
        ...
        if ($is_saved == true) {
            ...
            $tableEntries = Engine_Api::_()->getDbTable('entries', 'yndynamicform')->getEntryIDByProjectIdAndFormId($yndform->form_id, $project_id);
            if ($tableEntries) {
                $is_created_yn = true;
