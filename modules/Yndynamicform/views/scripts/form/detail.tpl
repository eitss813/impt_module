...
<script>
    ...
    $j(document).ready(function() {
        ...
        for (var i = 0, element; element = elements[i++];) {
            ...
            if( document.getElementById(matrics_aggregation_element_id+'-label') )
