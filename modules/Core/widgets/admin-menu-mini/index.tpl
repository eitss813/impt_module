...
<div id='global_header_right'>
  <div id='global_header_right_menu'>
    ...
    &nbsp;
    <?php endif; ?>
    <a href='<?php echo $this->url(array(), 'default', true) ?>' class='back_to_network'> <img src="<?php echo $this->layout()->staticBaseUrl .'/application/modules/Core/externals/images/admin/back-arrow.png'?>" /><?php echo $this->translate("back to network") ?></a>
    &nbsp;
    <a href='<?php echo $this->url(array(), 'user_logout') ?>' class='sign_out'><img src="<?php echo $this->layout()->staticBaseUrl .'application/modules/Core/externals/images/admin/logout.png'?>" /><?php echo $this->translate("sign out") ?></a>
  </div>
</div>
