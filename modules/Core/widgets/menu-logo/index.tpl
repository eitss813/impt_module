...
/*
// todo: Fixed the logo path to home page
...
// when logo clicked go to activity page

if($this->viewer()->getIdentity()){
    $route = array('route'=>'user_general', 'action'=>'home');
}else{
    $route = $this->layout()->staticBaseUrl . 'pages/activities';
}

echo $this->htmlLink($route, $this->htmlImage(Engine_Api::_()->core()->getFileUrl($logo), array('alt'=>$title)));
