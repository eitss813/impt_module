...
<div class="yndform_form_center yndform_form_grid_mode <?php echo ($this->item->photo_id) ? '' : 'yndform_form_no_photo'?>">
    ...
    <div class="yndform_image_parent">
        ...
        <div class="yndform_form_image_parent">
            <a href="dynamic-form/entry/create/1/form_id/<?php echo $this -> item -> form_id; ?>/user_id/<?php echo $this->user_id; ?>" class="yndform_form_image" style="background-image: url('<?php echo $photo_url ?>')">
            </a>
        </div>
    </div>
    ...
    <div class="yndform_info_parent">
        ...
        <div class="yndform_form_title" style="display: flex">
            ...
            <?php if($this->type == 'assign'): ?>
                <a href="dynamic-form/entry/create/1/form_id/<?php echo $this -> item -> form_id; ?>/user_id/<?php echo $this->user_id; ?>">
                    <?php echo $this -> item -> getTitle(); ?>
                </a>
            <?php endif; ?>

            <?php if($this->type == 'submit'): ?>
                <?php $entryRes =  Engine_Api::_()->getDbTable('projectforms', 'sitepage')->getEntryIdByUserFormId($this -> item -> form_id,$this->user_id); ?>
                <?php $entry_id = $entryRes[0]['entry_id']; ?>
                <a href="dynamic-form/entry/view/<?php echo $entry_id; ?>/type/user/id/<?php echo $this->user_id; ?>">
                    <?php echo $this -> item -> getTitle(); ?>
                </a>
                 <?php
                 ...
                 ?>
                    <a target="_blank" id="edit_button" href="dynamic-form/entry/edit/<?php echo $entry_id; ?>/type/user/id/<?php echo $this->user_id; ?>">
                        <?php echo "Edit"; ?>
                    </a>
                <?php endif; ?>
            <?php endif; ?>
