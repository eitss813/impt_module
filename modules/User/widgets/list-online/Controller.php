...
{
    // todo: 5.2.1 Upgrade => hided the online users as client said
    ...
    public function indexAction()
    {
        ...
        $this->view->isSuperAdmin = $isSuperAdmin= false;

        if( 1 === $viewer->level_id ) {
            $this->view->isSuperAdmin = $isSuperAdmin= true;
        }
