...
class User_Form_Login extends Engine_Form_Email
{
  ...
  public function init()
  {
    ...
    if($url == '/net/error/requireuser?redirect_url=/net/members/home'){
        $_SESSION['redirectURL']= '/net/members/home';
    }else if($url == '/net/error/requireuser?redirect_url=/net/members/home'){
        $_SESSION['redirectURL']= '/network/members/home';
    }else{
