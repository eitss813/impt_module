...
<br /><br />
The default currency can be chosen one time and can not be changed later. (If you wish to choose the default currency on your website, please contact our support team from  <a href="https://socialnetworking.solutions/support/create-new-ticket//" target="_blank">here</a>.) <br /><br />
