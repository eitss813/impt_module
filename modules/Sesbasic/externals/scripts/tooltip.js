...
(function($) {
	...
	$.fn.powerTip = function(opts) {
		...
		if(typeof sesadvancedactivityDesign != 'undefined' && sesadvancedactivityDesign == 2){
			sesJqueryObject('#activity-form .sesact_post_media_options').find("*").removeAttr('title');
	    	sesJqueryObject('#activity-form .sesact_post_media_options').find(".sesadv_tooltip").removeClass("sesadv_tooltip");
    	}
		// extend options
