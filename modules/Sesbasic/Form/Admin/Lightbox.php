  ...
  public function init() {
   ...
   $this->addElement('Radio', 'sesbasic_enable_lightbox', array(
    ...
    $this->addElement('Radio', 'sesbasic_show_information', array(
      ...
      'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbasic.show.information', 0),
    ));
    ...
    $this->addElement('Radio', 'sesbasic_add_delete', array(
        'label' => 'Delete',
        'description' => 'Do you want to Enable the delete button in the lightbox?',
        'multiOptions' => array(
            1 => 'Yes',
            0 => 'No'
        ),
    ...
    $this->addElement('Radio', 'sesbasic_add_share', array(
        'label' => 'Share',
        'description' => 'Do you want to Enable the Share button in the lightbox?',
        'multiOptions' => array(
            1 => 'Yes',
            0 => 'No'
        ),
    ...
    $this->addElement('Radio', 'sesbasic_add_report', array(
        'label' => 'Report',
        'description' => 'Do you want to Enable the Report button in the lightbox?',
        'multiOptions' => array(
            1 => 'Yes',
            0 => 'No'
        ),
