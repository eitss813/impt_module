 ...
 */
class Sitecrowdfunding_Widget_AjaxBasedProjectsHomeController extends Seaocore_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $sitecrowdfundingProjectHome = Zend_Registry::isRegistered('sitecrowdfundingProjectHome') ? Zend_Registry::get('sitecrowdfundingProjectHome') : null;
        ...
        if (empty($sitecrowdfundingProjectHome))
