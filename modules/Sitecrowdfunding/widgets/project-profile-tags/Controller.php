 ...
 */
class Sitecrowdfunding_Widget_ProjectProfileTagsController extends Engine_Content_Widget_Abstract {
...
//        }
        ...
        //FETCH TAGS
        $tag_cloud_array = $sitecrowdfunding_api->getProjectTagsByProjectId($itemCount, 0, $params, $project->getIdentity());
