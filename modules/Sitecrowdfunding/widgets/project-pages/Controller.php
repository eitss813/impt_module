 ...
 */
class Sitecrowdfunding_Widget_ProjectPagesController extends Seaocore_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $this->view->sitepage_browse = 'show';
        ...
        $this->view->columnWidth = $params['columnWidth'] = $this->_getParam('columnWidth', 212);
        ...
        //custom implementation to filter connected ids
        //GET PROJECT SUBJECT
        $subject = Engine_Api::_()->core()->getSubject();
        $this->view->resource_id = $resource_id = $subject->getIdentity();
        $pagesTable = Engine_Api::_()->getDbtable('pages', 'sitecrowdfunding');
        $result = $pagesTable->getProjectPages($resource_id);
        // filtering only selected page ids
        $values['selected_page_ids'] = $result;
        // filtering only selected page ids
        //custom implementation to filter connected ids
