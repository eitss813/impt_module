...
<ul class="sitepage_sidebar_list">
    ...
    <?php foreach ($this->user_projects as $id): ?>
        <li>
            <?php $project = Engine_Api::_()->getItem('sitecrowdfunding_project', $id); ?>
    ...
    <?php if($this->total_user_projects > 3):?>
        <?php $myProjectsUrl = $this->url(array('action' => 'manage'), 'sitecrowdfunding_general', true);?>
