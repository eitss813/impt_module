 ...
 */
class Sitecrowdfunding_View_Helper_SitecrowdfundingShareLinks extends Zend_View_Helper_Abstract {

    public function sitecrowdfundingShareLinks($subject, $params = array(), $showText = false) {
