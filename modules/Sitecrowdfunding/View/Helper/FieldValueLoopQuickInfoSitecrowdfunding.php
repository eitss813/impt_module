 ...
 * @version    $Id: FieldValueLoopQuickInfoSitecrowdfunding.php 2017-03-27 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitecrowdfunding_View_Helper_FieldValueLoopQuickInfoSitecrowdfunding extends Fields_View_Helper_FieldAbstract {

    public function fieldValueLoopQuickInfoSitecrowdfunding($subject, $partialStructure, $itemCount = 5) {
