 ...
 * @version    $Id: Searchprojectfields.php 2017-03-27 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitecrowdfunding_Form_Searchprojectfields extends Engine_Form {
    ...
    public function generate() {
        ...
        if ($this->_fieldType == 'sitecrowdfunding_project') {
        ...
        $structure = Engine_Api::_()->sitecrowdfunding()->getFieldsStructureSearch($this->_fieldType, $this->_topLevelId, $this->_topLevelValue, true, $profileTypeIds); 
