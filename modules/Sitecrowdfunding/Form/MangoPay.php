 ...
 * @version    $Id: MangoPay.php 2017-03-27 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitecrowdfunding_Form_MangoPay extends Engine_Form {

    public function init() {
        parent::init();

        $this->setTitle(sprintf(Zend_Registry::get('Zend_Translate')->translate('Personal Details for MangoPay Account')));
        $this->setName('sitecrowdfunding_mangopay_payment_info');
        $description = 'Enter your personal details below to be used in MangoPay account. <br />
<strong>[Note : You need to fill all the information accurately in ‘Personal Details for MangoPay Account’ and ‘MangoPay Bank Account Configuration’.]</strong><br />Below, you can configure your MangoPay Account to start receiving payments. This information should be accurately provided and enabled.<div id="show_mangopay_form_massges" class="tool_tip"></div>';
        // Decorators
