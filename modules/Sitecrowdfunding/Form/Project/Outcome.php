 ...
 */
class Sitecrowdfunding_Form_Project_Outcome extends Engine_Form {
    ...
    public function init() {
        ...
        $this->setTitle('Add Outcome');
        $this->setDescription(sprintf(Zend_Registry::get('Zend_Translate')->_("Add New Outcome using below form for this project.")))
            ->setAttrib('name', 'sitecrowdfundings_outcome_create')
            ->getDecorator('Description')->setOption('escape', false);

        $this->setAttrib('id', 'sitecrowdfundings_outcome_create_form');
