 ...
 */
class Sitecrowdfunding_Form_Project_OutcomeSettings extends Engine_Form
{
    ...
    public function init()
    {
        ...
        $this->addElement('Text', 'no_of_jobs', array(
            'label' => "How many jobs do you expect to create?",
            'allowEmpty' => true,
            'required' => false,
            'validators' => array(
                array('Float', false),
        ...
        $this->addElement('TinyMce', 'desire_desc', array(
            'label' => "What outcomes do you desire from this project?",
            'allowEmpty' => false,
