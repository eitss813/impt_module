 ...
 * @version    $Id: Gateways.php 2017-03-27 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitecrowdfunding_Model_DbTable_Gateways extends Engine_Db_Table {

    protected $_name = 'payment_gateways';
    protected $_rowClass = 'Sitecrowdfunding_Model_Gateway';
