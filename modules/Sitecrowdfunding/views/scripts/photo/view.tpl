...
<script type="text/javascript">
    ...
    en4.core.runonce.add(function () {
        taggerInstance = new Tagger('media_image_next', {
            ...
            'tagSitecrowdfundingElement': 'media_tags',
...
<div class='sitecrowdfunding_photo_view'>
    <div class="sitecrowdfunding_photo_nav">
        <div>
            <?php
    ...
    <div class='albums_viewmedia_info sitecrowdfunding_photo_info'>
        <div class='sitecrowdfunding_photo_container' id='media_image_div'>
            <a id='media_image_next' href='<?php echo $this->escape($this->image->getNextCollectible()->getHref()) ?>'>
                <?php echo $this->itemPhoto($this->image, null , $this->translate($this->image->getTitle()), array(
                   'id' => 'media_image',
               ));
             ?>
            </a>
        ...
        <?php if ($this->image->getTitle()): ?>
            <div class="sitecrowdfunding_photo_title">
                <?php echo $this->translate($this->image->getTitle()); ?>
            </div>
        <?php endif; ?>

        <?php if ($this->image->getDescription()): ?>
            <div class="sitecrowdfunding_photo_description">
                <?php echo $this->translate($this->image->getDescription()) ?>
            </div>
        <?php endif; ?>

        <div class="project_photo_tags" id="media_tags" class="tag_sitecrowdfunding" style="display: none;">
            <?php echo $this->translate('Tagged:'); ?>
        </div>
        <div class="sitecrowdfunding_photo_date">
            ...
            <?php if ($this->canEdit): ?>
                ...
                - <?php echo $this->htmlLink(array('route' => "sitecrowdfunding_photo_extended", 'controller' => 'photo', 'action' => 'edit', 'photo_id' => $this->image->getIdentity(), 'format' => 'smoothbox'), $this->translate('Edit'), array('class' => 'smoothbox')) ?>

                - <?php echo $this->htmlLink(array('route' => "sitecrowdfunding_photo_extended", 'controller' => 'photo', 'action' => 'remove', 'photo_id' => $this->image->getIdentity(), 'format' => 'smoothbox'), $this->translate('Delete'), array('class' => 'smoothbox')) ?>
            <?php endif; ?>
