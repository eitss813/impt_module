...
<div>
    ...
    <br/>
    <div class="clr">
        <?php $photo_btn_label = 'Add More Videos'; ?>
        <?php echo $this->htmlLink(array('route' => "sitecrowdfunding_photo_extended", 'controller' => 'photo', 'action' => 'upload-more-video', 'project_id' => $this->project_id, 'format' => 'smoothbox'), $this->translate($photo_btn_label), array('class' => 'upload_more_video_button button seaocore_icon_add smoothbox')) ?>
    </div>
                    ...
                    <div class="tip">
                        <span>
                            <?php if (!$this->integratedWithVideo): ?>
                                ...
                                <?php /* <?php echo $this->translate('There are currently no videos in this project. %1$sClick here%2$s to add your first video.', "<a href='$url'>", "</a>"); ?> */ ?>
                                <?php echo $this->translate('There are currently no videos in this project'); ?>
                            <?php else: ?>
                                <?php if (Engine_Api::_()->sitevideo()->openPostNewVideosInLightbox()): ?>
                                    ...
                                    <?php /* <?php echo $this->translate('There are currently no videos in this project. %1$sClick here%2$s to add your first video.', "<a class='seao_smoothbox' data-SmoothboxSEAOClass='seao_add_video_lightbox' href='$url'>", "</a>"); ?>*/ ?>
                                    <?php echo $this->translate('There are currently no videos in this project'); ?>
                                <?php else: ?>
                                    <?php $url = $this->url(array('action' => 'create', 'parent_type' => $this->project->getType(), 'parent_id' => $this->project->project_id, 'content_id' => $this->identity), "sitevideo_video_general", true); ?>
                                    <?php /* <?php echo $this->translate('There are currently no videos in this project. %1$sClick here%2$s to add your first video.', "<a href='$url'>", "</a>"); ?> */ ?>
