...
<div>
    ...
    <br/>
    <div class="clr">
        <?php $photo_btn_label = 'Add More Photos'; ?>
        <?php echo $this->htmlLink(array('route' => "sitecrowdfunding_photo_extended", 'controller' => 'photo', 'action' => 'upload-more-photo', 'project_id' => $this->project_id, 'format' => 'smoothbox'), $this->translate($photo_btn_label), array('class' => 'seaocore_icon_add upload_more_photo_button button  smoothbox')) ?>
    </div>
