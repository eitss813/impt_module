...
<div class="sitecrowdfunding_dashboard_content">
    ...
    <?php echo $this->partial('application/modules/Sitecrowdfunding/views/scripts/dashboard/header.tpl', array('project' => $this->project, 'sectionTitle'=>'Edit contact info', 'sectionDescription'=> 'Edit contact info for this project.')); ?>
