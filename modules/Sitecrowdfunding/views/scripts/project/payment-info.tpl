 ...
 * @version    $Id: payment-info.tpl 2017-03-27 9:40:21Z SocialEngineAddOns $
...
<div class="sitecrowdfunding_dashboard_content">
    <?php echo $this->partial('application/modules/Sitecrowdfunding/views/scripts/dashboard/header.tpl', array('project' => $this->project,  'isFundingSection'=> true, 'sectionTitle' => 'Payment Methods', 'sectionDescription'=> 'Below, you can choose the payment methods that you want to be available to backers during their backing process to Back this project.' )); ?>
    <?php if (empty($this->enablePaymentGateway)) : ?>
        <div> 
            <?php if ($this->paymentMethod == 'paypal'): ?>  
                ...
                <?php //echo $this->partial('_stripeConnectButton.tpl', 'sitegateway', array('stripeConnected' => $this->stripeConnected, 'show_stripe_form_massges' => false, 'resource_type' => 'sitecrowdfunding_project', 'resource_id' => $this->project_id)); ?>
                <?php //endif; ?>              
                <?php //endif; ?>    
    ...
    <?php else: ?>
        <?php if (is_array($this->enablePaymentGateway) && count($this->enablePaymentGateway) >= 1) : ?>
            ...
            <div id="project_payment_gateway" style="margin-top: 10px;" class="mbot10 sitecrowdfunding_seller_payment_options">
                ...
                <?php foreach ($this->enablePaymentGateway as $paymentGateway) : ?>
                    <?php if ($paymentGateway == 'paypal') : ?>
                        ...
                        <div class="global_form_desc">
                            <input type="checkbox" class="payment_method" id="sitecrowdfunding_gateway_paypal" onchange="selectProjectPaymentGateway(this.id, this.checked);" <?php
                        ...
                        <div id="sitecrowdfunding_gateway_paypal_form" class="sitecrowdfunding_dashboard_payment_method b_medium" <?php
                    ...
                    <?php if (Engine_Api::_()->hasModuleBootstrap('sitegateway') && Engine_Api::_()->sitegateway()->isValidGateway($paymentGateway)): ?>
                        ...
                        ?>
                        <?php if ($paymentGateway == 'stripe' && Engine_Api::_()->sitegateway()->isValidGateway($paymentGateway) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegateway.stripeconnect', 0)) : ?>
                            <div class="global_form_desc">
                                <input type="checkbox" class="payment_method" id="sitecrowdfunding_gateway_stripe" onchange="selectProjectPaymentGateway(this.id, this.checked);" <?php
                            ...
                            <div id="sitecrowdfunding_gateway_stripe_form" class="sitecrowdfunding_dashboard_payment_method b_medium" <?php
                            if (empty($this->stripeEnabled)) : echo 'style="display:none"';
                            endif;
                            ?> > 
                                     <?php echo $this->partial('_stripeConnectButton.tpl', 'sitegateway', array('stripeConnected' => $this->stripeConnected, 'show_stripe_form_massges' => true, 'resource_type' => 'sitecrowdfunding_project', 'resource_id' => $this->project_id)); ?>
                            </div>

                        <?php elseif ($paymentGateway == 'mangopay' && Engine_Api::_()->sitegateway()->isValidGateway($paymentGateway)) : ?>
                            <div class="global_form_desc">
                                <input type="checkbox" class="payment_method" id="sitecrowdfunding_gateway_mangopay" onchange="selectProjectPaymentGateway(this.id, this.checked);" <?php
                            ...
                            <div id="sitecrowdfunding_gateway_mangopay_form" class="sitecrowdfunding_dashboard_payment_method b_medium" <?php
                        ...
                        <?php else : ?>
                            <div class="global_form_desc">
                                <input type="checkbox" class="payment_method" id="sitecrowdfunding_gateway_<?php echo $gatewayName; ?>" onchange="selectProjectPaymentGateway(this.id, this.checked);" <?php
                                if (!empty($this->$gatewyEnabled)) : echo $this->translate("checked");
                                endif;
                                ?>>
                                <label for="sitecrowdfunding_gateway_<?php echo $gatewayName; ?>"><?php echo $this->translate($gatewayNameUC) ?></label>
                            </div>
                            <div id="sitecrowdfunding_gateway_<?php echo $gatewayName; ?>_form" class="sitecrowdfunding_dashboard_payment_method b_medium" <?php
            ...
            <div class='buttons' id="project_gateway_submit" style="display: block;">
                ...
                <button type='button' name="save_gateway" onclick="saveProjectGateway();"><?php echo $this->translate("Save") ?></button>
