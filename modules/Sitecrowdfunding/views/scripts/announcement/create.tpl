...
<div class="sitecrowdfunding_dashboard_content">
    <?php echo $this->partial('application/modules/Sitecrowdfunding/views/scripts/dashboard/header.tpl', array('project' => $this->project, 'sectionTitle' => 'Post New Announcement', 'sectionDescription' => 'Please compose a new announcement for your project below.')); ?>
    <div class="layout_middle">
        <div class="sitecrowdfunding_dashboard_form">
            <div id="show_tab_content">
                <div class="sitecrowdfunding_post_announcement">
