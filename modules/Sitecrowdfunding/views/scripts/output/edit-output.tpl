...
<div class="sitecrowdfunding_dashboard_content">
    ...
    <?php echo $this->partial('application/modules/Sitecrowdfunding/views/scripts/dashboard/header.tpl', array('project' => $this->project, 'sectionTitle'=>'Edit Output', 'sectionDescription'=> 'Edit Output using below form for this project.')); ?>
