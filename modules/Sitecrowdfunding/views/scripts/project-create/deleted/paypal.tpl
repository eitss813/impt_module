...
<div class="sitecrowdfunding_project_new_steps">
    ...
    <div class="sitecrowdfunding_dashboard_content">
        ...
        <div id="project_payment_gateway" style="margin-top: 10px;" class="mbot10 sitecrowdfunding_seller_payment_options">
            ...
            <div id="project_payment_gateway_notice">Note: You must input Paypal account information to receive Donations.</div>
...
<div class='buttons' id="project_prev_submit" style="display: block;">
    <?php echo $this->htmlLink(array('route' => 'sitecrowdfunding_createspecific','action'=>'step-seven','project_id' => $this->project_id ),$this->translate('Previous'), array('class' =>'button')) ?>
</div>
...
<div class='buttons fright last_btns' id="skip_project_gateway_submit" style="display: block;">
    <?php echo $this->htmlLink(array('route' => 'sitecrowdfunding_createspecific','action'=>'step-nine','project_id' => $this->project_id ),$this->translate('Skip'), array('class' =>'button')) ?>
</div>
        ...
        request = new Request.JSON({
            ...
            onSuccess: function (responseJSON) {
                ...
                if (responseJSON.success_message) {
                    ...
                    // go to next page
                    window.location.href = '<?php echo $this->url(array('action' => 'step-nine', 'project_id' => $this->project_id), 'sitecrowdfunding_createspecific', true) ?>';
                }
