...
<div class="sitecrowdfunding_project_new_steps">
    ...
    <h3 class="form_title">Payment Method</h3>
        ...
        <?php else: ?>
            ...
            <?php if (is_array($this->enablePaymentGateway) && count($this->enablePaymentGateway) >= 1) : ?>
                <div id="project_payment_gateway" style="margin-top: 10px;" class="mbot10 sitecrowdfunding_seller_payment_options">
                    ...
                    <div id="project_payment_gateway_notice">Note: If your not configured Paypal then donation button will be disabled.</div>
                    ...
                    <?php foreach ($this->enablePaymentGateway as $paymentGateway) : ?>
                        ...
                        <?php if (Engine_Api::_()->hasModuleBootstrap('sitegateway') && Engine_Api::_()->sitegateway()->isValidGateway($paymentGateway)): ?>
                            ...
                            <?php if ($paymentGateway == 'stripe' && Engine_Api::_()->sitegateway()->isValidGateway($paymentGateway) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegateway.stripeconnect', 0)) : ?>
                                ...
                                <div id="sitecrowdfunding_gateway_stripe_form" class="sitecrowdfunding_dashboard_payment_method b_medium" <?php if (empty($this->stripeEnabled)) : echo 'style="display:none"'; endif; ?> >
                            ...
                            <?php elseif ($paymentGateway == 'mangopay' && Engine_Api::_()->sitegateway()->isValidGateway($paymentGateway)) : ?>
                                ...
                                <div id="sitecrowdfunding_gateway_mangopay_form" class="sitecrowdfunding_dashboard_payment_method b_medium" <?php if (empty($this->mangopayEnable)) : echo 'style="display:none"'; endif; ?>>
                            ...
                            <?php else : ?>
                                ...
                                <div id="sitecrowdfunding_gateway_<?php echo $gatewayName; ?>_form" class="sitecrowdfunding_dashboard_payment_method b_medium" <?php if (empty($this->$gatewyEnabled)) : echo 'style="display:none"'; endif; ?>>
                                    <?php echo $this->$formName->render($this) ?>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                ...
                <div class='buttons' id="project_prev_submit" style="display: block;">
                    <?php echo $this->htmlLink(array('route' => 'sitecrowdfunding_createspecific','action'=>'step-six','project_id' => $this->project_id ),$this->translate('Previous'), array('class' =>'button')) ?>
                </div>

                <div class='buttons fright last_btns' id="project_gateway_submit" style="display: block;">
                ...
                <div class='fright last_btns or_label'>OR</div>

                <div class='buttons fright last_btns' id="skip_project_gateway_submit" style="display: block;">
                    <?php echo $this->htmlLink(array('route' => 'sitecrowdfunding_createspecific','action'=>'step-eight','project_id' => $this->project_id ),$this->translate('Skip'), array('class' =>'button')) ?>
                </div>
...
<style>
    ...
    #skip_project_gateway_submit{
        margin-top: 7px;
    }

    #skip_project_gateway_submit > a {
    ...
    #project_prev_submit > a{
        font-weight: inherit !important;
    }

    #project_payment_gateway_notice{
        color: red;
    }
...
<script lang="javascript/text">
    ...
    // todo: Naaziya this is not needed, as we show the paypal form automatically
    function showSubmitBtnByDefault(){
        $("project_gateway_submit").style.display = 'block';
    }
        ...
        request = new Request.JSON({
            ...
            onSuccess: function (responseJSON) {
                ...
                if (responseJSON.success_message) {
                    ...
                    // go to next page
                    window.location.href = '<?php echo $this->url(array('action' => 'step-eight', 'project_id' => $this->project_id), 'sitecrowdfunding_createspecific', true) ?>';
                }
