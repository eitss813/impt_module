...
<div class="sitecrowdfunding_project_new_steps">
    ...
    <div class="clr fright">
        <a style="font-weight: unset !important; float: left" class="button smoothbox"
           href="<?php echo $this->escape($this->url(array( 'controller'=> 'goals' , 'action'=>'add-goal', 'project_id' => $this->project_id,'layoutType' => 'projectStepsCreate'), 'sitecrowdfunding_extended', true)); ?>">
    ...
    <div class="button_group">
        ...
        <a style="font-weight: unset !important; float: left" class="prev_btn button"
           href="<?php echo $this->escape($this->url(array( 'action' => 'step-eight', 'project_id' => $this->project_id), 'sitecrowdfunding_createspecific', true)); ?>">
            <?php echo $this->translate("Previous"); ?>
        </a>
        <!-- Next -->
        <a style="font-weight: unset !important; float: right " class="next_btn button"
           href="<?php echo $this->escape($this->url(array( 'action' => 'step-ten', 'project_id' => $this->project_id), 'sitecrowdfunding_createspecific', true)); ?>">
