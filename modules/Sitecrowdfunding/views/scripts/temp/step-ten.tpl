...
<div class="sitecrowdfunding_project_new_steps">
    <div class="project_ready_intro">
        ...
        <h2 style="text-align: center;padding: 15px;font-weight: bold">
            Your project is ready. Here is link: <a style="color: #44AEC1;" href="<?php echo $this->project->getHref() ?>"><?php echo (_ENGINE_SSL ? 'https://' : 'http://') . $_SERVER['HTTP_HOST'].$this->project->getHref() ?> </a>
        </h2>

        <h3 class="form_sub_title">Add team members</h3>
