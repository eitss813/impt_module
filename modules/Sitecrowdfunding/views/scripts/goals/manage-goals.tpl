...
<div class="sitecrowdfunding_dashboard_content">
    <?php echo $this->partial('application/modules/Sitecrowdfunding/views/scripts/dashboard/header.tpl', array('project' => $this->project, 'sectionTitle'=>'SDG Goals', 'sectionDescription'=> 'Manage the Goals of this project.')); ?>
    <div class="sitecrowdfunding_dashboard_form">
        <div class="clr">
            <?php echo $this->htmlLink(array('module'=>'sitecrowdfunding', 'controller'=> 'goals' , 'action'=>'add-goal', 'project_id' => $this->project_id), $this->translate('Add Goal'), array('class' => 'button seaocore_icon_add output_btn')) ?>
        </div>
        <div class="organization-div">
            ...
            <div class="organization-list">
                    ...
                    <?php foreach($this->goals as $goal): ?>
                        ...
                        <div class="output_item">
                            <div class="output_info">
                                <h3 class="output_name"><b><?php echo $this->goals_ids[$goal['sdg_goal_id']]; ?></b></h3>
                            ...
                            <div class="output_description">
                                <?php echo $this->target_ids[$goal['sdg_target_id']]; ?>
                            </div>
                        </div>
                ...
                <div class="tip">
                            <span>
                                <?php echo $this->translate('No Goals for this project'); ?>
                            </span>
                </div>
