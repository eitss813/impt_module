...
<div class="sitecrowdfunding_dashboard_content">
    <?php echo $this->partial('application/modules/Sitecrowdfunding/views/scripts/dashboard/header.tpl', array('project' => $this->project, 'sectionTitle'=>'Output', 'sectionDescription'=> 'Manage the Goals of this project.')); ?>
                    ...
                    <?php foreach($this->goals as $goal): ?>
                        ...
                        <div class="output_item">
                            <div class="output_info">
                                <h3 class="output_name"><b><?php echo $goal['title']; ?></b></h3>
