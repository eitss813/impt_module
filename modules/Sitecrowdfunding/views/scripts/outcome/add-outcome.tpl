...
<div class="sitecrowdfunding_dashboard_content">
    ...
    <?php echo $this->partial('application/modules/Sitecrowdfunding/views/scripts/dashboard/header.tpl', array('project' => $this->project, 'sectionTitle'=>'Add New Outcome', 'sectionDescription'=> 'Add New Outcome using below form for this project.')); ?>
