...
<div class="sitecrowdfunding_dashboard_content">
    ...
    <?php echo $this->partial('application/modules/Sitecrowdfunding/views/scripts/dashboard/header.tpl', array('project' => $this->project, 'sectionTitle' => 'Privacy', 'sectionDescription' => 'Select privacy related information about this project.')); ?>
...
<style type="text/css">
    ...
    .sitecrowdfunding_project_form .form-label{
