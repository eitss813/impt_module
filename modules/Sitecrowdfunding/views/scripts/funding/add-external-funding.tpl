...
<div class="sitecrowdfunding_dashboard_content">
    ...
    <?php  if($this->layoutType != 'fundingDetails'): ?>
        <?php echo $this->partial('application/modules/Sitecrowdfunding/views/scripts/dashboard/header.tpl', array('project' => $this->project, 'isFundingSection'=> true, 'sectionTitle' => 'Add external funding', 'sectionDescription'=> 'Add external funding for this project using the form below.' )); ?>
    <?php endif; ?>

    <?php  if($this->layoutType == 'fundingDetails'): ?>
        <h3 class="form_title">Add external funding</h3>
    <?php endif; ?>
...
<script type="text/javascript">
    ...
    window.addEvent('domready',function(){
        checkingResourceType('organization');
