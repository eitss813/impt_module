...
class Serenity_Form_Admin_Settings_Styling extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addDisplayGroup(array('serenity_footer_background_color', 'serenity_footer_font_color', 'serenity_footer_links_color', 'serenity_footer_border_color'), 'footer_settings_group', array('disableLoadDefaultDecorators' => true));
