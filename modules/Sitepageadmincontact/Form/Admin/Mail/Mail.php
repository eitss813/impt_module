...
pages-extensions" target="_blank">new extensions</a>');
    ...
    $this->addElement('Text', 'page_contactemail_admin', array(
        ...
        'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('page.contactemail.admin', Engine_API::_()->seaocore()->getSuperAdminEmailAddress()),
    ));

    $this->page_contactemail_admin->getValidator('NotEmpty')->setMessage('Please enter a valid email address.', 'isEmpty');
    $this->page_contactemail_admin->getValidator('EmailAddress')->getHostnameValidator()->setValidateTld(false);
