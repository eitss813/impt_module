          ...
          <tbody>
            <?php foreach ($this->categories as $category): ?>
                    <tr>
                      ...
                      <td>
                        <?php echo $this->htmlLink(array('route' => 'group_extended', 'module' => 'group', 'controller' => 'admin-settings', 'action' => 'edit-category', 'id' =>$category->category_id), $this->translate("edit"), array(
                          'class' => 'smoothbox',
                        )) ?>
                        |
                        <?php echo $this->htmlLink(array('route' => 'group_extended', 'module' => 'group', 'controller' => 'admin-settings', 'action' => 'delete-category', 'id' =>$category->category_id), $this->translate("delete"), array(
                          'class' => 'smoothbox',
                        )) ?>
