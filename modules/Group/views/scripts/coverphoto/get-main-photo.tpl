        ...
        <table class="main_thumb_photo">
          <tr valign="middle">
            <td>
              ...
              <?php else : ?>
                <span style="background-image:url('application/modules/Group/externals/images/nophoto_group_thumb_profile.png'); text-align:left;" id="group_profile_photo"></span>
              <?php endif;?>
            </td>
          </tr>
        </table>
