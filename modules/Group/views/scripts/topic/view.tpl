              ...
              <div class="group_discussions_thread_details">
                <div class="group_discussions_thread_details_options">
                  ...
                  'onclick' => 'quotePost("'.$this->escape($user->getTitle()).'", "'.$this->escape($user->getHref()).'", this);',
                    ...
                    <?php endif; ?>
                  <?php endif; ?>
                  <?php if( ($post->user_id == $this->viewer()->getIdentity() || $this->group->getOwner()->getIdentity() == $this->viewer()->getIdentity()) && $this->canPostEdit): ?>
                  ...
                  <?php endif; ?>
                  <?php if( ($post->user_id == $this->viewer()->getIdentity() || $this->group->getOwner()->getIdentity() == $this->viewer()->getIdentity()) && $this->canPostDelete): ?>
