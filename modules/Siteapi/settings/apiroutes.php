...
$routes['advancedactivity'] = array(
    ...
    'advancedactivity_feed_general' => array(
        ...
        'reqs' => array(
            'action' => '(index|post|hide-item|un-hide-item|likes-comments|attach-link|open-close|feed-decoration|on-this-day|feed-post-menus|follow)',
        ),
    ),
...
$routes['sitepage'] = array(
    'sitepage_specific' => array(
        ...
        'reqs' => array(
            'action' => '(view|edit|index|delete|close|publish|claim|messageowner|tellafriend|information|follow|overview|get-contact|org)',
            // 'page_id' => '\d+',
        ),
    ),
    'sitepage_org' => array(
...
//    'sitepage_fixs' => array(
//        'route' => 'sitepage/:action/:page_id/:initiative_id/*',
//        'defaults' => array(
//            'module' => 'sitepage',
//            'controller' => 'profile',
//            'action' => 'fixs',
...
//        ),
//    ),
    'sitepage_category' => array(
        'route' => 'crowdfunding/:action/:category_id/*',
        'defaults' => array(
            'module' => 'sitepage',
            'controller' => 'profile',
            'action' => 'category',
...
$routes['livestreamingvideo'] = array(
    'Livestreamingvideo_api_general' => array(
        ...
        'reqs' => array(
            'action' => '(start-video-streaming|stop-video-streaming|view-video-streaming|delete-streaming|delete-all-Streaming|is-live|share-video|process-notification)'
        ),
    ),
    );
