 ...
 * @license    http://www.socialengine.com/license/
 */
class Siteloginconnect_Form_Settings_General extends Engine_Form
{
  protected $_item;
  ...
  public function init()
  {
    ...
    $socialSites=Array(0=>'facebook',1=>'linkedin',2=>'twitter',3=>'instagram',4=>'google',5=>'yahoo',6=>'outlook',7=>'pinterest',8=>'flickr',9=>'vk');
    ...
    foreach ($socialSites as $socialsite) {
        ...
        if (!empty($siteEnabled)) {          
            if (in_array($socialsite, $socialsiteslink,Boolean)) {
                $Ssocialsite = ucfirst($socialsite);
                if($socialsite == 'facebook') {
                    ...
                    if( 'none' != $facebook_enable ) {
                      ...
                      $this->addElement('Dummy', 'facebook', array(
                        ...
                        'description' => $desc,
                        'content' => Engine_Api::_()->siteloginconnect()->getfacebookButton('Log In'),
                      ));
                    ...
                    if( 'none' != $twitter_enable ) {
                      ...
                      $this->addElement('Dummy', 'twitter', array(
                        ...
                        'description' => $desc,
                        'content' => Engine_Api::_()->siteloginconnect()->gettwitterButton('Log In'),
                      ));
                  ...
                  $socialsitename=$Ssocialsite;
                  if($Ssocialsite=='Linkedin'){
                    $socialsitename='LinkedIn';
                  }
                  $desc = 'Linking your '.$socialsitename.' account will let you login with '.$socialsitename;
                  $functionname='get'.$socialsite.'Button';
                  $this->addElement('Dummy',$socialsite, array(
                    'label' => $socialsitename.' Integration',
                    'description' => $desc,
                    'content' => Engine_Api::_()->siteloginconnect()->$functionname('Log In'),
                  ));
                  $this->addElement('Checkbox', $socialsite.'_id', array(
                    'label' => 'Integrate with my '.$Ssocialsite,
                    'description' => $Ssocialsite.' Integration',
                  ));
                }                
            }
        }            
