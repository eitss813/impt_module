    	...
    	<ul>
      	<?php foreach ($this->tabs as $item) : ?>
	        <li class="package-list">
	          ...
	          <div style="width:23%;" class='admin_table_centered'>
	            <?php echo ( $item->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitepagealbum', 'controller' => 'photo', 'action' => 'enabled', 'tab_id' => $item->tab_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepagealbum/externals/images/enabled1.gif', '', array('title' => $this->translate('Disable Tab'))), array())  : $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitepagealbum', 'controller' => 'photo', 'action' => 'enabled', 'tab_id' => $item->tab_id), $this->htmlImage($this->layout()->staticBaseUrl.'application/modules/Sitepagealbum/externals/images/enabled0.gif', '', array('title' => $this->translate('Enable Tab')))) ) ?>
	          </div>
          	<div style="width:23%;" class='admin_table_centered'>
