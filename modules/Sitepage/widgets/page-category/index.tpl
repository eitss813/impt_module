...
<div id="image_view" class="sitecrowdfunding_cat_gd_wrap sitecrowdfunding_cat_grid_view sitecrowdfunding_cat_sub_grid_view clr">
    <ul class="sitecrowdfunding_cat_gd">
        <?php foreach ($this->categoryParams as $categoryData): ?>

        <?php $category = Engine_Api::_()->getItem('sitecrowdfunding_category', $categoryData['category_id']);?>
        <li class="seao_cat_gd_col fleft g_b" style="height: <?php echo $this->columnHeight; ?>px; width: <?php echo $this->columnWidth; ?>px;">
            <div class="box" style="height: <?php echo $this->columnHeight; ?>px; width: <?php echo $this->columnWidth; ?>px;">
                <div class="seao_cat_gd_cnt">
                    ...
                    <?php if (!empty($category->photo_id)): ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <a href="javascript:void(0);" onclick="goToCategorySearchPage(<?php echo $category->category_id ?>)" class="dblock seao_cat_gd_img" style="background-image: url('<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitecrowdfunding/externals/images/categories_default_image.jpg');"></a>
                    <?php endif; ?>
                </div>

                <a href="javascript:void(0);" onclick="goToCategorySearchPage(<?php echo $category->category_id ?>)">
                            ...
                            <?php if (!empty($category->file_id)): ?>
                                ...
                                <?php if (!empty($temStorage)): ?>
                                    ...
                                    <span class = "title_category_with_icon">
                                        ...
                                        <br>
                                        <?php echo $categoryData['projects_count'].' Projects';?>
                                    </span>
                                <?php endif; ?>
...
<script type="text/javascript">
    ...
    function goToCategorySearchPage(category_id){
