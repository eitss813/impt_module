...
class Sitepage_Widget_PageCoverInformationSitepageController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
   ...
   //   $count = Engine_Api::_()->getDbtable('follows', 'seaocore')->numberOfFollow($resource_type, $resource_id);
    $memberCount = Engine_Api::_()->getDbtable('follows', 'seaocore')->numberOfMembers($resource_id);
    $followerscount = Engine_Api::_()->getDbtable('follows', 'seaocore')->numberOfFollows($resource_type, $resource_id);
    $this->view->follow_count  = $followerscount;
    $this->view->member_count  = $memberCount;
