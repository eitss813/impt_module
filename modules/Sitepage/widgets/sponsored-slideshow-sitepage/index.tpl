...
foreach ($this->show_slideshow_object as $type => $item) {
  ...
  if($postedBy && $sitepage->show_name):
...
if (!empty($this->sitepage_sponsored)) {
  ...
  <script type="text/javascript">
    window.addEvent('domready',function(){
      ...
      var width=$(globalContentElement).getElement(".seaocore_slideshow_wrapper").clientWidth;
      $(globalContentElement).getElement(".seaocore_slideshow_mask").style.width= (width-10)+"px";
