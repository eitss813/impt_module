...
<?php else :?>
		...
		<div class="tip">
	  	<span><?php echo $this->translate('You cannot access this setting as you have disabled Page Profile Layout editing by their owners from the "Edit Page Layout" field in Global Settings. '); ?></span> 
	  </div>
