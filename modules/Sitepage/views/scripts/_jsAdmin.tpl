...
<script type="text/javascript">
  ...
  var registerEvents = function() {
    ...
    // Attach edit field
    $$('.field > .item_options > a').removeEvents().addEvent('click', uiSmoothEditField);

    // Attach delete field
    $$('.field > .item_options > a:last-child').removeEvents().addEvent('click', uiConfirmDeleteField);
  ...
  var uiSmoothTopOptionCreate = function(spec) {
    ...
    if(page_id != null && page_id != '' && page_id != 0 && page_id != '0'){
        url += '/field_id/' + topLevelFieldId + '/page_id/' + page_id +'/format/smoothbox';
    }else{
  ...
  var uiSmoothOptionEdit = function(option) {
    ...
    if(page_id != null && page_id != '' && page_id != 0 && page_id != '0'){
        url += '/option_id/' + option + '/page_id/' +page_id +'/format/smoothbox';
    }else{
  ...
  var uiSmoothTopOptionEdit = function(spec) {
    ...
    if(page_id != null && page_id != '' && page_id != 0 && page_id != '0'){
        url += '/option_id/' + topLevelOptionId + '/page_id/' + page_id + '/format/smoothbox';
    }else{
  ...
  var uiSmoothCreateField = function(spec) {
    ...
    if(page_id != null && page_id != '' && page_id != 0 && page_id != '0'){
        url += '/option_id/' + ids.suboption_id + '/page_id/' + page_id +'/parent_id/' + ids.parent_id + '/format/smoothbox';
    }else{
  ...
  var uiSmoothTopFieldCreate = function(type) {
    if (type == 'heading')
      return uiSmoothTopHeadingCreate();
    var url = urls.field.create;
    if(page_id != null && page_id != '' && page_id != 0 && page_id != '0'){
      url += '/option_id/' + topLevelOptionId +  '/page_id/' + page_id + '/parent_id/' + topLevelFieldId + '/type/' + type + '/format/smoothbox';
    }else{
      url += '/option_id/' + topLevelOptionId + '/parent_id/' + topLevelFieldId + '/type/' + type + '/format/smoothbox';
    }
    Smoothbox.open(url);
  };
  ...
  var uiSmoothEditField = function(spec) {
    ...
    if(page_id != null && page_id != '' && page_id != 0 && page_id != '0'){
      url += '/option_id/' + topLevelOptionId + '/page_id/' + page_id +'/field_id/' + ids.child_id + '/format/smoothbox';
    }else{
      url += '/option_id/' + topLevelOptionId + '/field_id/' + ids.child_id + '/format/smoothbox';
    }
    Smoothbox.open(url);
  }
  ...
  var uiSmoothTopHeadingCreate = function(spec) {
    ...
    if(page_id != null && page_id != '' && page_id != 0 && page_id != '0'){
        url += '/option_id/' + topLevelOptionId + '/page_id/' + page_id +'/parent_id/' + topLevelFieldId + '/format/smoothbox';
    }else{
