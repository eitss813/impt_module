    ...
    <div class="generic_layout_container layout_core_content">
        ...
        <div class="layout_middle">
            ...
            <div class="sitepage_edit_content">
                ...
                <div class="sesbasic_search_reasult">
                    <?php echo $this->htmlLink(array( 'route' => 'admin_default','module' => 'sesmultipleform', 'controller' => 'fields', 'action' => 'index'), $this->translate("Custom fields"), array('class'=>'smoothbox sesbasic_icon_add buttonlink')) ?>
                </div>
                ...
                <form id='multidelete_form' method="post" action="<?php echo $this->url();?>" onSubmit="return multiDelete()">
                    <div class="sesbasic_manage_table">
                        <div class="sesbasic_manage_table_head" style="width:100%;">
                            ...
                            <div style="width:15%"><?php echo $this->translate("Form Title") ?></div>
                            ...
                            <div style="width:15%"><?php echo $this->translate("Assign Projects") ?></div>
                        </div>
                        <ul  class="sesbasic_manage_table_list" id='menu_list' style="width:100%;">
                            ...
                            <li class="item_label" id="form_<?php echo $item->form_id ?>">
                                ...
                                <div style="width:15%"><?php echo $item->title; ?></div>
                                ...
                                <div style="width:20%">
                                    <?php echo $this->htmlLink(array( 'module' => 'sitepage', 'controller' => 'manageforms', 'action' => 'advance-setting', 'id' => $item->form_id,'page_id'=>$this->page_id), $this->translate("Edit"), array()) ?>
                                    |
                                    <?php echo $this->htmlLink(array('module' => 'sitepage', 'controller' => 'manageforms', 'action' => 'categories', 'id' => $item->form_id,'page_id'=>$this->page_id), $this->translate("Manage Categories"), array()) ?>
                                    |
                                    <?php echo $this->htmlLink(array( 'module' => 'sitepage', 'controller' => 'forms', 'action' => 'entry', 'id' => $item->form_id), $this->translate("Manage Entries"), array()) ?>
                                    <br />
                                    <?php echo $this->htmlLink(array( 'module' => 'sitepage', 'controller' => 'forms', 'action' => 'email-confirmation', 'id' => $item->form_id), $this->translate("Send Confirmation Email"), array()) ?>
                                    |
                                ...
                                <div style="width:15%">
                                    <a class=" send_msg smoothbox" href="<?php echo $this->url(array('controller' => 'manageforms','action' => 'select-project','form_id' => $item->form_id,'page_id' => $this->page_id)); ?>">
                                    Select Project
                                    </a>
