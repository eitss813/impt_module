...
<script type="text/javascript">
    ...
    window.addEvent('domready', function() {
        ...
        $('page_ids-label').style.display='none';
    });
    ...
    en4.core.runonce.add(function() {
        // if( !isPopulated ) {
        new Autocompleter.Request.JSON('page_ids', '<?php echo $this->url(array('module' => 'sitepage', 'controller' => 'partner', 'action' => 'get-partners', 'page_id' => $this->page_id), 'default', true) ?>', {
            'postVar' : 'page_ids',
            'postData' : false,
            'minLength': 1,
            'delay' : 250,
            ...
            onPush : function(){
                ...
                if( $('toValues').value.split(',').length >= maxRecipients ){
                    $('page_ids').disabled = true;
                }
            }
        });
        new Composer.OverText($('page_ids'), {
