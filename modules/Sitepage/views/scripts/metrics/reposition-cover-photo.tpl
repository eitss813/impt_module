  ...
  <div style="margin:20px">
    <div class="uploaded_photo_custom align_center" style="height: 500px">
      <div id="sitecrowdfunding_edit_media_thumb_custom" style="height: 470px;max-width: 650px">
        <img id="main_photo_custom_id" src="<?php echo $this->metric->getLogoUrl(); ?>" alt="" id="lassoImg" class="thumb_profile_edit thumb_profile item_photo_sitecrowdfunding_project ">
     <div class="image_container">
       <img id="display_photo_custom_id" style='height: 300px;width: 200px;object-fit: contain;' src="<?php echo $this->metric->getLogoUrl('thumb.cover'); ?>" />
     </div>
...
<script type="text/javascript">
  ...
  function saveData(coordinates){
    var request = new Request.JSON({
      url: en4.core.baseUrl + 'sitepage/metrics/save-cropped-image',
      method: 'POST',
      data: {
        format: 'json',
        coordinates: coordinates,
        metric_id: '<?php echo $this->metric_id ?>',
        photo_id: '<?php echo $this->metric->logo; ?>'
      },
      onRequest: function () {
