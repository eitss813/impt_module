...
class Sitepage_Form_Admin_Categories_Add extends Engine_Form {
  ...
  public function init() {
    ...
    if( empty($isThirdLevelCat) ) {
      ...
      if (!empty($category_id) && $perform == 'edit') {
        ...
        if ($category->photo_id && !empty($getCategoryPhoto)) {
          ...
          $description = "<img src='$photoName' class='sr_sitepage_categories_banner_img' />";
    ...
    if (!empty($category_id) && $perform == 'edit') {
      ...
      if ($category->file_id && Engine_Api::_()->storage()->get($category->file_id, '')) {
        ...
        $description = "<img src='$photoName' class='sr_sitepage_categories_icon' />";
