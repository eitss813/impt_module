// this only use for lightbox not use in others
// we have remove baseY and using this in view.tpl and set dynamically line no 306
var Tagger = new Class({
  ...
  options : {
    ...
    'title' : false,
    'description' : false,
    'transImage' : en4.core.staticBaseUrl+'application/modules/Seaocore/externals/images/trans.gif',
    'existingTags' : [],
  ...
  addTag : function(params) {
    ...
    if ( 'object' != $type(params) ) {
      ...
      return;
		...
		// we have remove baseY and using this in view.tpl and set dynamically 
    var baseX = 0,baseY=0,  baseW = 0, baseH = 0;
    baseY=this.options.baseY;
    this.options.baseY=0;
