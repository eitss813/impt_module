...
class Sitepage_Api_MobilelayoutCore extends Core_Api_Abstract {
    ...
    public function setWithoutTabContent($page_id, $sitepage_layout_cover_photo) {
        ...
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitemusic')) {
            $this->setDefaultInfoWithoutTab('sitemusic.contenttype-music', $page_id, 'Music', 'true', '125');
        }
    }
    ...
    public function setTabbedLayoutContent($page_id, $sitepage_layout_cover_photo) {
        ...
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitemusic')) {
            $this->setContentDefaultInfo('sitemusic.contenttype-music', $page_id, 'Music', 'true', '125');
        }
    }
